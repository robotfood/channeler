export const AUDIO_PROFILES = ['none', 'standard', 'surround_5_1', 'surround_5_1_aggressive'] as const
...
export function normalizeAudioProfile(value: string | null | undefined): AudioProfile {
  ...
  return AUDIO_PROFILES.includes(value as AudioProfile) ? value as AudioProfile : 'none'
}
